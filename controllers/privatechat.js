          ...
          getchatPage:function(req,res){
            async.parallel([
              ...
              console.log(result3);
                            ...
                            const newParams = params[0];
console.log(newParams);


              res.render('private/privatechat',{name:newParams,chats:result3,title:'Footbalkik- Private Chat',chat:result2,user:req.user,data:result1});

            });
          },
          chatPostPage:function(req,res){

              const params = req.params.name.split('.');
              const newParams = params[0];
              const nameRegex = new RegExp("^"+newParams.toLowerCase(),'i');
