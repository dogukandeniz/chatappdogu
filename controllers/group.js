  ...
  return{
      ...
      async.parallel([
          ...
          function(callback){
            ...
            if(req.body.message){
                  ...
                  group.name = req.body.groupNamef;
    ...
    groupPage:function(req,res){
        ...
        async.parallel([
          ...
          res.render('groupchat/group',{groupMsg:result3,chat:result2,title:'Footballkik - Group',user:req.user,groupName:name,data:result1});
